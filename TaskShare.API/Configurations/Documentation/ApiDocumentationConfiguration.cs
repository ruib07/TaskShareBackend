...
using TaskShare.API.Constants;

namespace TaskShare.API.Configurations.Documentation
{
    public static class ApiDocumentationConfiguration
    {
        ...
        public static void UseCustomApiDocumentation(this IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint($"/swagger/{ApiConstants.DocumentationGroupAuthentication}/swagger.json", "TaskShare Api - Authentication");
                options.SwaggerEndpoint($"/swagger/{ApiConstants.DocumentationGroupEntity}/swagger.json", "TaskShare Api - Entity");
            });
        }
    }
}
